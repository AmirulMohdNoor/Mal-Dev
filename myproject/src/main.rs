...
use windows::{
    ...
    Win32::{
        ...
        System::{Threading::{CreateEventW, ResetEvent, WaitForSingleObject}, IO::{IO_STATUS_BLOCK}},
    }
};
...
// This struct is less useful for parsing responses directly due to byte order and variable names.
// Instead, we'll read fields directly from the response_buffer.
// #[repr(C)]
// struct DNSClientResponseAnswerHeaderStruct {
//     w_name: u16, // This is actually part of the name field, could be a pointer
//     w_type: u16,
//     w_class: u16,
//     w_ttl: [u16; 2], // This should be a u32
//     w_length: u16,
// }
...
fn main() -> Result<(), NTError> {
    println!("NTSockets - File Download PoC - www.x86matthew.com\n");
